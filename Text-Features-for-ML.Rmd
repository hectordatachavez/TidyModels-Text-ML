...
one <- collect_predictions(svm_rs) %>%
...
# Returns a large tibble with .pred_class for each recipe
four <- collect_predictions(svm_rs) %>%
...
Make a plot of the 15 most important terms in predicting type of Netflix title based on thei coefficients.
