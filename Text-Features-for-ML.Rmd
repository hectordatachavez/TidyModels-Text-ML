---
title: 'Building features from text to predicting classes'
...
```{r explore_data, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r data_exploration_plot, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r data_exploration_description_plot, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r model_recipes, echo=FALSE, warning=FALSE, message=FALSE}
...
# Set plot canvas
# patwork_confmat <- one + four
# 
# # Print plots
# patwork_confmat + plot_annotation(
