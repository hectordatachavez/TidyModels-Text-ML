...
- To combine sub-word features from the item title to the model
...
This column contains the description of the Movies and TV Shows: are all about 150 characters long. 

The histogram also highlights the issue of balance in the sample: there are more movies than TV Shows.
...
## Build a model
```{r original_model_prep, echo=FALSE, warning=FALSE}
...
tidy(netflix_fit) %>%
  ...
  mutate(
    term = str_remove(term, "tfidf_"),
    term = str_remove(term, "tf_"),
